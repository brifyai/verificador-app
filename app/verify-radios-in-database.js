...
/**
 * VERIFICAR: Radios en base de datos
 * Para confirmar que las radios de las grabaciones están en la tabla radios
 */
...
function findMatches(radios, recordingRadioIds) {
  ...
  recordingRadioIds.forEach(radioId => {
    ...
    if (matchById || matchByVpsId) {
      ...
      const matchType = matchById ? 'id_radio' : 'vps_id';
      matches.push({
...
// Función principal
async function main() {
  console.log(colors.cyan.bold('\n=== VERIFICACIÓN: RADIOS VS GRABACIONES ===\n'));

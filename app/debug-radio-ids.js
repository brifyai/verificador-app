// Script para diagnosticar IDs de radios en Supabase vs filenames del VPS
import dotenv from 'dotenv';
import path from 'path';
import { fileURLToPath } from 'url';
import { supabaseDirect } from './lib/supabase-direct.js';
...
async function debugRadioIds() {
  console.log('🔍 DIAGNÓSTICO DE IDs DE RADIOS');

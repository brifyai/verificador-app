...
# Script para matar todos los servidores y liberar el puerto 5000 (Ubuntu compatible)
...
echo "========================================"
ss -tlnp | grep :5000 || echo "No hay procesos en puerto 5000"
echo ""

echo "PASO 2: MATAR TODOS LOS PROCESOS NODE"
echo "========================================"
pkill -f "node" || echo "No hay procesos node"
...
ss -tlnp | grep :5000 || echo "✅ Puerto 5000 está libre"
echo ""
...
echo "========================================"
echo "Puertos en uso:"
ss -tlnp | grep :500 || echo "✅ No hay procesos en puertos 500x"
echo ""

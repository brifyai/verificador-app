...
async function diagnoseRadioDifferences() {
  console.log('🔍 DIAGNÓSTICO: Comparación entre radios Fmmas y Fmokey usando Recording Service\n');

  try {
    // Obtener lista de radios del servicio de grabación
    console.log('📡 Obteniendo lista de radios del servicio de grabación...');

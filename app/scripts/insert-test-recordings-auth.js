...
/**
 * Script para insertar datos de prueba usando autenticación
 * Usa el token JWT válido para autenticarse
 */
...
// Token JWT válido (del archivo admin-token.txt)
const ADMIN_TOKEN = 'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXCI9.eyJlbWFpbCI6ImFkbWluQG9uZGF2ZXJpZmljYWRhLmNvbSIsImlkIjoiYWRtaW4iLCJyb2xlIjoiYWRtaW4iLCJpYXQiOjE3MzMwNzIwMDAsImV4cCI6MjA0ODYzMjAwMH0.7pC7Y3z6vX2sZ8qW5tU9rP1mN4bV8cX2aL6sK3fG9hJ';

console.log('🧪 Insertando datos de prueba con autenticación...');
...
async function insertTestData() {
  try {
    console.log('📊 Insertando 3 grabaciones de prueba con autenticación...');

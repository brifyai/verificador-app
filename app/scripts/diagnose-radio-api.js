...
// Script para diagnosticar radios usando la API directamente
...
async function diagnoseRadioDifferences() {
  try {
    console.log('🔍 Diagnóstico de diferencias entre radios Fmmas y Fmokey usando API...\n');

    // Primero obtener todos los radios
    console.log('Buscando radios...');
    const allRadios = await makeRequest('/api/radios');
